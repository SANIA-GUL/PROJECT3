...
layer4=convolution2dLayer([3 3],64,'NumChannels',64,'Stride',3,'Padding','same','Name','Encoder-Stage-1-Conv-2');
lgraph=replaceLayer(lgraph,'Encoder-Stage-1-Conv-2',layer4);
layer7=convolution2dLayer([3 3],128,'NumChannels',64,'Stride',3,'Padding','same','Name','Encoder-Stage-2-Conv-1');
lgraph=replaceLayer(lgraph,'Encoder-Stage-2-Conv-1',layer7);
layer9=convolution2dLayer([3 3],128,'NumChannels',128,'Stride',3,'Padding','same','Name','Encoder-Stage-2-Conv-2');
lgraph=replaceLayer(lgraph,'Encoder-Stage-2-Conv-2',layer9);
layer21=convolution2dLayer([3 3],128,'NumChannels',256,'Stride',3,'Padding','same','Name','Decoder-Stage-1-Conv-1');
lgraph=replaceLayer(lgraph,'Decoder-Stage-1-Conv-1',layer21);
layer23=convolution2dLayer([3 3],128,'NumChannels',128,'Stride',3,'Padding','same','Name','Decoder-Stage-1-Conv-2');
lgraph=replaceLayer(lgraph,'Decoder-Stage-1-Conv-2',layer23);
layer28=convolution2dLayer([3 3],64,'NumChannels',128,'Stride',3,'Padding','same','Name','Decoder-Stage-2-Conv-1');
lgraph=replaceLayer(lgraph,'Decoder-Stage-2-Conv-1',layer28);
layer30=convolution2dLayer([3 3],64,'NumChannels',64,'Stride',3,'Padding','same','Name','Decoder-Stage-2-Conv-2');
lgraph=replaceLayer(lgraph,'Decoder-Stage-2-Conv-2',layer30);
